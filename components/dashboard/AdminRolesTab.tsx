  ...
  return (
    <div className="space-y-6">
      <div className="border-b border-slate-800 pb-4">
        ...
        <p className="text-xs text-slate-400">Update system clearances and elevate employee roles</p>
      </div>

      <form onSubmit={onSubmit} className="space-y-6 max-w-xl bg-slate-900/40 border border-slate-800 rounded-2xl p-6">
        <div className="space-y-4">
          <div className="space-y-1.5">
            <label className="text-[10px] font-bold uppercase tracking-wider text-slate-400">User ID (UUID) *</label>
            <input
              type="text" required
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Assign Role Clearance</label>
            <select
              value={roleForm.role}
