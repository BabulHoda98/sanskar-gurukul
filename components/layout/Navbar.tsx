      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex lg:hidden items-center gap-2">
            <Link href="https://wa.me/918409696021" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center text-green-600 hover:text-green-700 bg-green-50 p-2 rounded-full transition-colors" aria-label="WhatsApp">
